...
const translations: Translations = {
  ...
  feature1Desc: { vi: 'POS ONE giúp hộ kinh doanh bán hàng nhanh chóng và chính xác. Hệ thống hỗ trợ đa ngành nghề như quán ăn, cà phê, tạp hóa, thời trang, phụ kiện, bida, sân thể thao, khu vui chơi, spa, salon tóc. Giao diện được thiết kế theo từng ngành nghề, thân thiện và dễ sử dụng trên mọi thiết bị: điện thoại, tablet, máy POS cầm tay, máy POS để bàn, laptop,... — giúp bán hàng mượt mà ở bất kỳ đâu.', en: 'POS ONE helps businesses sell quickly and accurately. The system supports multiple industries such as restaurants, cafes, groceries, fashion, accessories, billiards, sports courts, entertainment areas, spa, hair salons. The interface is designed for each industry, user-friendly and easy to use on all devices: phones, tablets, handheld POS machines, desktop POS machines, laptops,... - helping smooth sales anywhere.', ko: 'POS ONE은 기업이 빠르고 정확하게 판매할 수 있도록 지원합니다. 시스템은 레스토랑, 카페, 식료품점, 패션, 액세서리, 당구장, 스포츠 코트, 오락 구역, 스파, 미용실 등 다양한 산업을 지원합니다. 인터페이스는 각 산업에 맞게 설계되었으며, 모든 기기에서 사용자 친화적이고 사용하기 쉽습니다: 휴대폰, 태블릿, 휴대용 POS 기기, 데스크톱 POS 기기, 노트북 등... - 어디서나 원활한 판매를 지원합니다.', zh: 'POS ONE帮助企业快速准确地销售。系统支持多个行业，如餐厅、咖啡馆、杂货店、时装、配饰、台球、运动场、娱乐区、水疗、美发沙龙。界面针对每个行业设计，用户友好，易于在所有设备上使用：手机、平板电脑、手持POS机、台式POS机、笔记本电脑等... - 帮助在任何地方顺利销售。', ja: 'POS ONEは、ビジネスが迅速かつ正確に販売できるよう支援します。システムは、レストラン、カフェ、食料品店、ファッション、アクセサリー、ビリヤード、スポーツコート、エンターテイメントエリア、スパ、ヘアサロンなど、複数の業界をサポートします。インターフェースは各業界向けに設計されており、すべてのデバイスでユーザーフレンドリーで使いやすいです：携帯電話、タブレット、ハンドヘルドPOSマシン、デスクトップPOSマシン、ノートパソコンなど... - どこでもスムーズな販売をサポートします。' },
  ...
  feature2Desc: { vi: 'POS ONE cho phép xuất hóa đơn điện tử ngay tại quầy, tích hợp trực tiếp trong phần mềm bán hàng. Giải pháp tuân thủ Thông tư 78/2021/TT-BTC của Tổng cục Thuế, đáp ứng đầy đủ quy định về hóa đơn điện tử. Hộ kinh doanh không cần thao tác thủ công hay chuyển dữ liệu sang hệ thống khác, giúp tiết kiệm thời gian và hạn chế sai sót.', en: 'POS ONE allows issuing electronic invoices right at the counter, directly integrated into the sales software. The solution complies with Circular 78/2021/TT-BTC of the General Department of Taxation, fully meeting electronic invoice regulations. Businesses do not need manual operations or transfer data to other systems, saving time and minimizing errors.', ko: 'POS ONE은 판매 소프트웨어에 직접 통합되어 카운터에서 바로 전자 송장을 발행할 수 있습니다. 이 솔루션은 국세청의 회람 78/2021/TT-BTC를 준수하며 전자 송장 규정을 완전히 충족합니다. 기업은 수동 작업이나 다른 시스템으로 데이터를 전송할 필요가 없어 시간을 절약하고 오류를 최소화합니다.', zh: 'POS ONE允许在柜台直接开具电子发票，直接集成到销售软件中。该解决方案符合税务总局第78/2021/TT-BTC号通告，完全符合电子发票规定。企业无需手动操作或将数据传输到其他系统，节省时间并最大限度地减少错误。', ja: 'POS ONEは、販売ソフトウェアに直接統合され、カウンターで直接電子請求書を発行できます。このソリューションは、税務総局の通達78/2021/TT-BTCに準拠し、電子請求書規制を完全に満たしています。企業は手動操作や他のシステムへのデータ転送が不要で、時間を節約し、エラーを最小限に抑えます。' },
  
  feature3: { vi: 'Kết nối thanh toán điện tử', en: 'Electronic Payment Integration', ko: '전자 결제 연동', zh: '电子支付集成', ja: '電子決済統合' },
  feature3Desc: { vi: 'POS ONE hỗ trợ thanh toán linh hoạt qua QR Code, chuyển khoản ngân hàng hoặc ví điện tử. Mọi giao dịch được ghi nhận tức thì và đồng bộ với hệ thống doanh thu, hóa đơn. Giải pháp giúp tối ưu trải nghiệm thanh toán cho khách hàng, đồng thời giảm thời gian xử lý cho nhân viên bán hàng.', en: 'POS ONE supports flexible payment via QR Code, bank transfer or e-wallet. All transactions are recorded instantly and synchronized with the revenue and invoice system. The solution helps optimize payment experience for customers while reducing processing time for sales staff.', ko: 'POS ONE은 QR 코드, 은행 송금 또는 전자 지갑을 통한 유연한 결제를 지원합니다. 모든 거래는 즉시 기록되고 매출 및 송장 시스템과 동기화됩니다. 이 솔루션은 고객의 결제 경험을 최적화하면서 판매 직원의 처리 시간을 줄입니다.', zh: 'POS ONE支持通过二维码、银行转账或电子钱包灵活支付。所有交易都会立即记录并与收入和发票系统同步。该解决方案有助于优化客户的支付体验，同时减少销售人员的处理时间。', ja: 'POS ONEは、QRコード、銀行振込、または電子ウォレットを介した柔軟な支払いをサポートします。すべての取引は即座に記録され、収益および請求書システムと同期されます。このソリューションは、顧客の支払い体験を最適化し、販売スタッフの処理時間を短縮します。' },
  
  feature4: { vi: 'Quản lý kho thông minh', en: 'Smart Inventory Management', ko: '스마트 재고 관리', zh: '智能库存管理', ja: 'スマート在庫管理' },
  feature4Desc: { vi: 'Tính năng quản lý kho của POS ONE giúp bạn kiểm soát tồn kho theo thời gian thực, tự động trừ hàng khi bán và cảnh báo khi sắp hết. Hỗ trợ quản lý theo lô, nhóm hàng hoặc chi nhánh, giúp hộ kinh doanh vận hành hiệu quả, linh hoạt và chính xác hơn.', en: 'POS ONE\'s inventory management feature helps you control stock in real-time, automatically deducts goods when sold and alerts when running low. Supports management by batch, product group or branch, helping businesses operate more efficiently, flexibly and accurately.', ko: 'POS ONE의 재고 관리 기능은 실시간으로 재고를 제어하고, 판매 시 자동으로 상품을 차감하며, 재고가 부족할 때 알림을 제공합니다. 배치, 제품 그룹 또는 지점별 관리를 지원하여 기업이 더 효율적이고 유연하며 정확하게 운영할 수 있도록 돕습니다.', zh: 'POS ONE的库存管理功能可帮助您实时控制库存，销售时自动扣除商品，并在库存不足时发出警报。支持按批次、产品组或分支机构进行管理，帮助企业更高效、灵活和准确地运营。', ja: 'POS ONEの在庫管理機能は、リアルタイムで在庫を管理し、販売時に自動的に商品を差し引き、在庫が不足すると警告します。バッチ、製品グループ、または支店別の管理をサポートし、企業がより効率的、柔軟、正確に運営できるよう支援します。' },
  ...
  feature5Desc: { vi: 'POS ONE giúp theo dõi dòng tiền vào – ra rõ ràng, ghi nhận mọi khoản thu, chi và chi phí vận hành. Báo cáo lợi nhuận, lãi lỗ được tổng hợp tự động, giúp chủ hộ kinh doanh dễ dàng nắm bắt tình hình tài chính mà không cần chuyên môn kế toán.', en: 'POS ONE helps track cash flow clearly, recording all income, expenses and operating costs. Profit and loss reports are automatically compiled, helping business owners easily grasp the financial situation without accounting expertise.', ko: 'POS ONE은 현금 흐름을 명확하게 추적하고 모든 수익, 지출 및 운영 비용을 기록합니다. 손익 보고서는 자동으로 컴파일되어 회계 전문 지식 없이도 사업주가 재무 상황을 쉽게 파악할 수 있도록 돕습니다.', zh: 'POS ONE帮助清楚地跟踪现金流，记录所有收入、支出和运营成本。利润和亏损报告会自动编制，帮助企业主在没有会计专业知识的情况下轻松掌握财务状况。', ja: 'POS ONEは、すべての収入、支出、運営コストを記録し、キャッシュフローを明確に追跡します。損益レポートは自動的にコンパイルされ、会計の専門知識がなくても事業主が財務状況を簡単に把握できるよう支援します。' },
  ...
  feature6Desc: { vi: 'POS ONE tích hợp hệ thống CRM mini lưu trữ thông tin khách hàng, lịch sử mua hàng, sinh nhật, sở thích... Hỗ trợ thẻ thành viên, tích điểm và hạng mức ưu đãi, giúp hộ kinh doanh chăm sóc khách hàng cá nhân hóa, tăng độ trung thành và tần suất quay lại mua hàng.', en: 'POS ONE integrates a mini CRM system that stores customer information, purchase history, birthdays, preferences... Supports membership cards, loyalty points and reward tiers, helping businesses provide personalized customer care, increase loyalty and return frequency.', ko: 'POS ONE은 고객 정보, 구매 이력, 생일, 선호도를 저장하는 미니 CRM 시스템을 통합합니다... 회원 카드, 로열티 포인트 및 보상 등급을 지원하여 기업이 개인화된 고객 관리를 제공하고 충성도와 재방문 빈도를 높일 수 있도록 돕습니다.', zh: 'POS ONE集成了一个小型CRM系统，存储客户信息、购买历史、生日、偏好... 支持会员卡、积分和奖励等级，帮助企业提供个性化客户关怀，提高忠诚度和回购频率。', ja: 'POS ONEは、顧客情報、購入履歴、誕生日、好みを保存するミニCRMシステムを統合します... 会員カード、ロイヤルティポイント、報酬ティアをサポートし、企業がパーソナライズされた顧客ケアを提供し、ロイヤルティとリピート頻度を高めるのを支援します。' },
  
  feature7: { vi: 'Khuyến mãi & Marketing tự động', en: 'Promotions & Auto Marketing', ko: '프로모션 및 자동 마케팅', zh: '促销与自动营销', ja: 'プロモーション＆自動マーケティング' },
  feature7Desc: { vi: 'POS ONE hỗ trợ đa dạng chương trình khuyến mãi: voucher, combo, flash sale, giảm giá theo sản phẩm hoặc khung giờ. Hệ thống tự động áp dụng khuyến mãi khi bán hàng, giúp thu hút khách hàng hiệu quả mà vẫn đảm bảo kiểm soát chi phí.', en: 'POS ONE supports diverse promotion programs: vouchers, combos, flash sales, product or time-based discounts. The system automatically applies promotions during sales, helping attract customers effectively while ensuring cost control.', ko: 'POS ONE은 다양한 프로모션 프로그램을 지원합니다: 바우처, 콤보, 플래시 세일, 제품 또는 시간대별 할인. 시스템은 판매 중 자동으로 프로모션을 적용하여 비용을 통제하면서 효과적으로 고객을 유치하는 데 도움이 됩니다.', zh: 'POS ONE支持多样化的促销计划：优惠券、套餐、闪购、产品或时间段折扣。系统在销售期间自动应用促销，在确保成本控制的同时有效吸引客户。', ja: 'POS ONEは、多様なプロモーションプログラムをサポートします：バウチャー、コンボ、フラッシュセール、製品または時間帯別割引。システムは販売中に自動的にプロモーションを適用し、コスト管理を確保しながら効果的に顧客を引き付けるのに役立ちます。' },
  ...
  feature8Desc: { vi: 'Phù hợp cho các mô hình như karaoke, bida, sân tennis, pickleball, spa, salon tóc... POS ONE cho phép đặt lịch, tính tiền theo giờ hoặc gói dịch vụ. Giao diện trực quan giúp nhân viên thao tác nhanh, giảm nhầm lẫn và nâng cao trải nghiệm khách hàng.', en: 'Suitable for models like karaoke, billiards, tennis courts, pickleball, spa, hair salons... POS ONE allows booking, hourly billing or service packages. Intuitive interface helps staff operate quickly, reduce confusion and enhance customer experience.', ko: '카라오케, 당구장, 테니스 코트, 피클볼, 스파, 미용실 등의 모델에 적합합니다... POS ONE은 예약, 시간당 청구 또는 서비스 패키지를 허용합니다. 직관적인 인터페이스는 직원이 빠르게 작업하고 혼란을 줄이며 고객 경험을 향상시키는 데 도움이 됩니다.', zh: '适用于卡拉OK、台球、网球场、匹克球、水疗、美发沙龙等模型... POS ONE允许预订、按小时计费或服务套餐。直观的界面帮助员工快速操作，减少混淆并增强客户体验。', ja: 'カラオケ、ビリヤード、テニスコート、ピックルボール、スパ、ヘアサロンなどのモデルに適しています... POS ONEは、予約、時間課金、またはサービスパッケージを許可します。直感的なインターフェースは、スタッフが迅速に操作し、混乱を減らし、顧客体験を向上させるのに役立ちます。' },
  
  feature9: { vi: 'Kế toán dành cho Hộ kinh doanh', en: 'Accounting for Businesses', ko: '사업자를 위한 회계', zh: '企业会计', ja: '事業者向け会計' },
  feature9Desc: { vi: 'POS ONE cung cấp đầy đủ sổ sách kế toán theo Thông tư 88/2021/TT-BTC, đảm bảo tuân thủ quy định của Cơ quan Thuế. Hệ thống tự động tổng hợp doanh thu, chi phí, lợi nhuận và báo cáo thuế, giúp hộ kinh doanh quản lý minh bạch và dễ dàng hơn.', en: 'POS ONE provides complete accounting books according to Circular 88/2021/TT-BTC, ensuring compliance with Tax Authority regulations. The system automatically aggregates revenue, expenses, profits and tax reports, helping businesses manage transparently and more easily.', ko: 'POS ONE은 회람 88/2021/TT-BTC에 따른 완전한 회계 장부를 제공하여 세무 당국 규정을 준수합니다. 시스템은 수익, 비용, 이익 및 세금 보고서를 자동으로 집계하여 기업이 투명하고 더 쉽게 관리할 수 있도록 돕습니다.', zh: 'POS ONE根据第88/2021/TT-BTC号通告提供完整的会计账簿，确保符合税务机关规定。系统自动汇总收入、支出、利润和税务报告，帮助企业更透明、更轻松地管理。', ja: 'POS ONEは、通達88/2021/TT-BTCに従った完全な会計帳簿を提供し、税務当局の規制に準拠することを保証します。システムは、収益、経費、利益、税務報告を自動的に集計し、企業がより透明で簡単に管理できるよう支援します。' },
  
  feature10: { vi: 'Tích hợp & mở rộng thông minh', en: 'Smart Integration & Expansion', ko: '스마트 통합 및 확장', zh: '智能集成与扩展', ja: 'スマート統合＆拡張' },
  feature10Desc: { vi: 'POS ONE tích hợp linh hoạt với Zalo, Facebook, Website, GrabFood, ShopeeFood để mở rộng kênh bán hàng và chăm sóc khách hàng giúp đồng bộ đơn hàng online tự động và quản lý tập trung. Hệ thống hỗ trợ AI Agents giúp tự động tư vấn, gợi ý sản phẩm, chăm sóc khách hàng 24/7 và cung cấp báo cáo trực quan, giúp chủ kinh doanh ra quyết định nhanh, chính xác và tăng doanh thu hiệu quả.', en: 'POS ONE flexibly integrates with Zalo, Facebook, Website, GrabFood, ShopeeFood to expand sales channels and customer care, helping automatically synchronize online orders and centralized management. The system supports AI Agents to automatically consult, suggest products, provide 24/7 customer care and provide visual reports, helping business owners make quick, accurate decisions and increase revenue effectively.', ko: 'POS ONE은 Zalo, Facebook, 웹사이트, GrabFood, ShopeeFood와 유연하게 통합되어 판매 채널과 고객 관리를 확장하고 온라인 주문을 자동으로 동기화하며 중앙 집중식 관리를 지원합니다. 시스템은 AI 에이전트를 지원하여 자동으로 상담하고 제품을 제안하며 24/7 고객 관리를 제공하고 시각적 보고서를 제공하여 사업주가 빠르고 정확한 결정을 내리고 수익을 효과적으로 증가시킬 수 있도록 돕습니다.', zh: 'POS ONE与Zalo、Facebook、网站、GrabFood、ShopeeFood灵活集成，扩展销售渠道和客户关怀，帮助自动同步在线订单和集中管理。系统支持AI代理自动咨询、建议产品、提供24/7客户关怀和可视化报告，帮助企业主快速准确地做出决策并有效增加收入。', ja: 'POS ONEは、Zalo、Facebook、ウェブサイト、GrabFood、ShopeeFoodと柔軟に統合され、販売チャネルと顧客ケアを拡大し、オンライン注文の自動同期と一元管理を支援します。システムは、AIエージェントをサポートして自動的に相談し、製品を提案し、24時間365日の顧客ケアを提供し、視覚的なレポートを提供して、事業主が迅速かつ正確な決定を下し、効果的に収益を増やすのを支援します。' },
